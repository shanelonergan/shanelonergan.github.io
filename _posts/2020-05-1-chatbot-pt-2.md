...
Lets break this down into two steps:

### Part 1: Determine if any of the results are above 0.75
...
![Diagram of data flow through functions](https://i.imgur.com/fBTxAue.png)
